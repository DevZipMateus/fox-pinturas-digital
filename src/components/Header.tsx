  ...
  return (
    ...
    >
      <nav className="container-custom mx-auto px-4 md:px-8">
        ...
        {/* Mobile Navigation */}
        {isMobileMenuOpen && (
          <div className="md:hidden absolute top-20 left-0 right-0 bg-background shadow-custom-lg animate-fade-in">
              ...
              {navLinks.map((link) => (
                <li key={link.href}>
                  <a
                    ...
                    className="block px-6 py-3 text-foreground font-medium hover:bg-secondary hover:text-accent transition-colors"
                  >
                    {link.label}
                  </a>
                </li>
