...
const Contact = () => {
  const contactInfo = [
    ...
    },
    {
      ...
      content: 'Segunda a Quinta: 8h-12h / 13h-18h',
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="mt-8 p-6 bg-primary rounded-2xl">
              <h3 className="font-semibold text-primary-foreground mb-4">Siga-nos nas redes sociais</h3>
              <div className="flex gap-4">
                <a
                  href="https://www.facebook.com/foxpinturaapo"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-primary-foreground/10 rounded-xl flex items-center justify-center transition-all duration-300 hover:bg-primary-foreground/20"
          ...
          {/* CTA Card */}
          <div className="bg-gradient-to-br from-accent to-orange-dark rounded-3xl p-8 md:p-12 text-center flex flex-col justify-center">
            <h3 className="text-2xl md:text-3xl font-bold text-accent-foreground mb-4">
              Solicite seu orçamento agora
            </h3>
            <p className="text-accent-foreground/90 mb-8 max-w-md mx-auto">
